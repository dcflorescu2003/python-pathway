...
-- Update trigger to allow bypass from trusted SECURITY DEFINER functions
...
AS $function$
BEGIN
  -- Allow bypass from trusted SECURITY DEFINER functions (e.g. deactivate_teacher_mode)
...
-- Update deactivate_teacher_mode to set bypass flag
