              ...
              <div className="rounded-lg border-2 border-primary bg-primary/5 p-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-foreground/70">Până la <span className="font-semibold text-foreground">150 teste salvate</span> (față de 100 verificat / 50 neverificat), max. 4 itemi AI/test</p>
                  </div>
                  <div className="flex items-start gap-2">
